...
<section>
	...
	<div class="heroe">
      ...
      <img height="255" title="Logo" class ="center" alt="Visit friuliadomicilio.it official website!" src="<?php echo base_url(); ?>/pictures/friuli_a_domicilio_cut.png">
		<h1>Benvenuti su Friuli a Domicilio! </h1>

		<!--<h2>The small framework with powerful features</h2>-->

	</div>

	<h1>Che cos'è Friuli a Domicilio?</h1>

	<p>Friuli a Domicilio ti permette di scoprire sempre in tempo reale quali sono i ristoranti o i negozi che consegnano a domicilio nel tuo comune, ed entrare immediatamente in contatto con loro.</p>

	<p>Clicca subito su</p>

	<pre><code>Cerca Attività</code></pre>

	<p>Altrimenti, se vuoi sapere quali sono quelli che ti permettono il ritiro della merce in negozio, clicca su</p>

	<pre><code>Ritiro in loco</code></pre>
