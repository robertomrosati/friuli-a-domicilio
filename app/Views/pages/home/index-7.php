	<main>
				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-xl-9 col-lg-10 col-md-8">
							<h1>Take away or Delivery Food</h1>
							<p>The best restaurants at the best price</p>
							<form method="post" action="grid-listing-filterscol-delivery.html">
		...
		<div class="container margin_60_40">
			    ...
			    <div class="item">
			        <div class="strip">
			            <figure>
			                ...
			                <a href="detail-restaurant-delivery.html" class="strip_info">
			                    <small>Pizza</small>
			...
			<div class="banner lazy" data-bg="url(<?php echo base_url();?>/foogra_v.1.2/html/img/banner_bg_desktop.jpg)">
				<div class="wrapper d-flex align-items-center opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.2)">
					<div>
						...
						<a href="grid-listing-filterscol-delivery.html" class="btn_1">View All</a>
					</div>
				</div>
				<!-- /wrapper -->
			</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="list_home">
						<ul>
							<li>
								<a href="detail-restaurant-delivery.html">
									<figure>
			...
			<!-- /row -->
			<p class="text-center d-block d-md-block d-lg-none"><a href="grid-listing-filterscol-delivery.html" class="btn_1">View All</a></p>
